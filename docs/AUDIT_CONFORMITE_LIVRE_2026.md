...
| B9 — Santé technique | **8,0** | **450/450 tests passés** (dont 23 garde-fous d'intégrité du corpus) ; **0 rouge** — les 7 échecs ont été corrigés (voir le paragraphe « Tests rouges » ci-dessous) ; `tsc --noEmit` propre, `npm run build` OK |
