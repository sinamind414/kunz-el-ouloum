...
| B9 — Santé technique | **8,0** | **459/459 tests passés** (dont 28 garde-fous d'intégrité du corpus) ; **0 rouge** — les 7 échecs ont été corrigés (voir le paragraphe « Tests rouges » ci-dessous) ; `tsc --noEmit` propre, `npm run build` OK |
