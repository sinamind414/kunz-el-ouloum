...
> **Note de lecture du registre.** Il compte **55 constats** numérotés de 1 à 57 : les numéros **#34 et #35 n'ont jamais été attribués** (saut de numérotation lors du lot 3, et non lignes supprimées — vérifié dans l'historique Git). Répartition actuelle : **34 résolus**, **2 partiellement résolus** (#33, #47), **1 invalidé** (#4), **18 ouverts**. Un pipe littéral figurant dans une cellule doit être écrit `\|` et **jamais** `\|`, faute de quoi la ligne se scinde et le tableau devient illisible — quatre lignes présentaient ce défaut et ont été corrigées.
