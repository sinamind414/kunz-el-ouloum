...
export const DOCUMENT_PRACTICE_CONTEXTS: DocumentPracticeContext[] = [
  ...
  },
  {
    ...
    domain: 'immuno',
    sourceStatus: 'adaptation_pedagogique',
    documentTypeAr: 'منحنى كمية الأجسام المضادة بدلالة الزمن بعد تعرض أول وثانٍ للمستضد',
    goalAr: 'تفسير لماذا الاستجابة المناعية الثانوية أسرع وأقوى من الأولية.',
    ...
    trapAr: 'لا تخلط بين الاستجابة الأولية والثانوية من حيث السرعة والشدة.',
    altAr: 'منحنى يظهر كمية الأجسام المضادة بعد تعرض أول وثانٍ: الاستجابة الثانية أقوى وأسرع.',
    observationAr: 'الاستجابة الثانية تتميز بزمن كمون أقصر وكمية أجسام مضادة أكبر مقارنة بالأولية.',
    promptObserveAr: 'قارن بين الاستجابة الأولية والثانوية من حيث زمن الكمون وكمية الأجسام المضادة.',
    promptProduceAr: 'فسّر لماذا الاستجابة الثانية أسرع وأقوى من الأولى مع التمثيل بخلايا الذاكرة.',
    hintsAr: [
      'انظر إلى الفرق في زمن الكمون بين الاستجابتين.',
      'ما هي الخلايا التي تبقى من التعرض الأول؟',
    ],
    correctionAr:
      'الاستجابة الثانوية أسرع وأقوى لأن خلايا الذاكرة المتكونة من التعرض الأول تتعرف على المستضد بسرعة وتكاثر وتتمايز بسرعة إلى خلايا منتجة للأجسام المضادة.',
    criteria: {
