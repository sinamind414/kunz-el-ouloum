// passiveLessonIcons.test.ts — Verrou de la navigation « icône après icône »
// des leçons passives (décision propriétaire 2026-09-22).
//
// Contrats : les 11 unités du catalogue ont une icône (licite, distincte) ;
// les 47 chapitres passifs — sur TOUS les domaines et TOUTES les unités —
// reçoivent une icône licite ; les règles sémantiques ne se marchent pas
// dessus (Gauge avant Boxes, Layers avant BatteryCharging) ; déterminisme.

import { describe, expect, it } from 'vitest';
import { ICONES_AUTORISEES, UNIT_ICON_KEY, uniteIcone, chapitreIcone } from './passiveLessonIcons';
import { PASSIVE_DOMAINS, hasHtmlFile, getPassiveLessonTitle } from './lessonModes';
