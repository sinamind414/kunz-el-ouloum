...
const S2_EX2: AttenduItem[] = [
  ...
  // 'edaravone' ajouté : avec les frontières latines (formePresente), le nom
  // complet ne déclenche plus la forme courte 'eda' — il devient une forme à part.
  item(0.5, ['يتفاعل الادارافون', 'eda', 'edaravone'],
