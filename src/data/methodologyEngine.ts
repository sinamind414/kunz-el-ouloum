...
export const VERB_CARDS: VerbCard[] = [
  ...
  { id:'verb_schema_v1', verbAr:'لَخِّصْ فِي مُخَطَّطْ', verbFr:'Schématiser / Résumer', category:'descriptive',
    ...
    badExample:{ answer:'رسم أسهم عشوائية بين كلمات "نواة"، "بروتين" بدون اتجاه الأسهم وبدون تحديد المقرات.', flawDescription:'غياب المنهجية الهندسية، غياب العنوان المؤطر، وعدم تحديد المقرات البيولوجية.', circledError:'أسهم بدون عناوين وبدون تأطير', errorTag:'missing_conclusion', scorePercent:15 },
    criteria:[
  ...
  // MIFTAH+ ح — صيغتان خاصتان (calcul / pedigree) — extension excellence 10→12
  { id:'verb_calcul_v1', verbAr:'احْسُبْ', verbFr:'Calculer', category:'reasoned',
    goal:'تطبيق قانون بالحروف ثم تعويض خطوة بخطوة ثم نتيجة بوحدتها — الحساب يبدأ بالقانون.',
    structureSteps:['1. القانون بالحروف (Chargaff : %A = %T …)','2. التعويض خطوة خطوة','3. النتيجة بوحدتها'],
    requiredConnectors:['حسب قانون…','بالتعويض…','ومنه…'],
    forbiddenPatterns:['نتيجة بلا قانون','نتيجة بلا وحدة'],
    stopCriteria:['قانون بالحروف مذكور','تعويض مفصل','نتيجة بوحدتها'],
  ...
  { id:'verb_pedigree_v1', verbAr:'حَدِّدْ نَمَطَ الوِرَاثَةِ', verbFr:'Déterminer le mode', category:'reasoned',
    goal:'استخراج حدثين حاسمين ثم تعليل الاستبعاد ثم الحكمان ثم الأنماط بالترميز.',
    structureSteps:['1. حدثان حاسمان: ① أبوان سليمان ← طفل مصاب (السيادة) ② بنت مصابة من أب سليم / ابن سليم من أم مصابة (الموقع)','2. لماذا كل حدث يستبعد الفرضية المقابلة','3. الحكمان (متنحٍّ/سائد + جسمي/مرتبط بـ X) ثم الأنماط الوراثية بالترميز'],
    requiredConnectors:['الحدث الحاسم ①…','الحدث الحاسم ②…','لأن… وبالتالي…','ومنه النمط…'],
    forbiddenPatterns:['حكم واحد فقط','أنماط بلا حكم مبرر'],
    stopCriteria:['حدثان حاسمان مذكوران','حكمان مذكوران','أنماط بالترميز'],
...
export const TRAINING_EXERCISES: TrainingExercise[] = [
  ...
  { id:'ex_analyse_photosynthesis_07', verbId:'verb_analyse_v1', theme:'energy_transformations', themeAr:'التحولات الطاقوية', supportType:'courbe', supportTitle:'الوثيقة 7: منحنى البناء الضوئي بدلالة شدة الإضاءة', context:'تم قياس معدل البناء الضوئي في نباتات خضراء تحت شدة إضاءة متزايدة. يلاحظ المنحنى ارتفاعاً ثم استقراراً.', question:'حلل منحنى الوثيقة 7 الممثل لمعدل البناء الضوئي بدلالة شدة الإضاءة.', dataSnippet:'عند 20 ميكرومول/م².ث: 2 ميكرومول/دقيقة.\nعند 50 ميكرومول/م².ث: 8 ميكرومول/دقيقة.\nعند 100 ميكرومول/م².ث: 15 ميكرومول/دقيقة.\nعند 150 ميكرومول/م².ث: استقرار عند 15 ميكرومول/دقيقة.', diagramUrl:'/assets/images/schemas/domaine2_energie/schema_86_photosynthese_intensite_lumiere_modern_ar.svg', stage1:{ expertAnswer:'تمثل الوثيقة 7 منحنى معدل البناء الضوئي بدلالة شدة الإضاءة، حيث نلاحظ:\n- عند شدة إضاءة منخفضة (20 ميكرومول/م².ث): معدل ضعيف يقدر بـ 2 ميكرومول/دقيقة.\n- عند شدة إضاءة متوسطة (50 ميكرومول/م².ث): ارتفاع تدريجي إلى 8 ميكرومول/دقيقة.\n- عند شدة إضاءة عالية (100 ميكرومول/م².ث): أقصى معدل يبلغ 15 ميكرومول/دقيقة.\n- عند شدة إضاءة قصوى (150 ميكرومول/م².ث): استقرار عند 15 ميكرومول/دقيقة.\nالاستنتاج: يزيد معدل البناء الضوئي مع شدة الإضاءة حتى يصل إلى أقصى قيمة ثم يستقر.', segments:[{stepNumber:1,text:'تمثل الوثيقة 7 منحنى معدل البناء الضوئي بدلالة شدة الإضاءة',colorClass:'bg-blue-100 dark:bg-blue-900/40 text-blue-800 dark:text-blue-300'},{stepNumber:2,text:'من 2 إلى 8 ثم 15 ميكرومول/دقيقة، واستقرار عند 15 ميكرومول/دقيقة',colorClass:'bg-emerald-100 dark:bg-emerald-900/40 text-emerald-800 dark:text-emerald-300'},{stepNumber:3,text:'ارتفاع تدريجي مع زيادة شدة الإضاءة',colorClass:'bg-amber-100 dark:bg-amber-900/40 text-amber-800 dark:text-amber-300'},{stepNumber:4,text:'الاستنتاج: يزيد المعدل حتى أقصى قيمة ثم يستقر',colorClass:'bg-purple-100 dark:bg-purple-900/40 text-purple-800 dark:text-purple-300'}] }, stage2:{ clozePrompt:'تمثل الوثيقة 7 {{1}} حيث نلاحظ:\n- شدة منخفضة: {{2}}.\n- شدة متوسطة: {{3}}.\n- شدة عالية: {{4}}.\nالاستنتاج: {{5}}.', blanks:[{id:'1',expectedText:'منحنى معدل البناء الضوئي بدلالة شدة الإضاءة',hint:'تقديم الوثيقة'},{id:'2',expectedText:'2 ميكرومول/دقيقة',hint:'معدل ضعيف'},{id:'3',expectedText:'8 ميكرومول/دقيقة',hint:'تزايد'},{id:'4',expectedText:'15 ميكرومول/دقيقة',hint:'ذروة'},{id:'5',expectedText:'يزيد المعدل حتى أقصى قيمة ثم يستقر',hint:'الاستنتاج'}] }, stage3:{ recommendedTimeSec:180, hints:['تأكد من ذكر شدة الإضاءة مع الوحدات','صِف مرحلة الاستقرار بالقيم','لا تذكر الكلوروفيل في التحليل، اتركه للاستنتاج'] }, stage4:{ timeLimitSec:180, passIcmThreshold:90 } },
  { id:'ex_explain_leaf_08', verbId:'verb_explain_v1', theme:'energy_transformations', themeAr:'التحولات الطاقوية', supportType:'schema', supportTitle:'الوثيقة 8: مقطع ورقة نباتية', context:'الورقة النباتية هي عضو أساسي في البناء الضوئي، تتكون من طبقات متعددة تسمح بامتصاص الضوء وتبادل الغازات.', question:'فسر كيف يسمح التركيب التشريحي للورقة بقيامها بعملية البناء الضوئي.', dataSnippet:'البشرة العليا: حماية وسماح بنفاذ الضوء.\nالنسيج البالي: غني بالبلاستيدات الخضراء.\nالنسيج المكون للأسفلية: موقع البناء الضوئي.\nالبشرة السفلية: الثغور لتبادل الغازات.', diagramUrl:'/assets/images/schemas/domaine2_energie/schema_87_coupe_feuille_modern_ar.svg', stage1:{ expertAnswer:'الملاحظة: تتكون الورقة من بشرة علوية شفافة، ونسيج بالي غني بالبلاستيدات الخضراء، ونسيج مكون للأسفلية، وبشرة سفلية تحتوي على الثغور.\nالتفسير: يعود ذلك إلى أن البشرة العليا الشفافة تسمح بنفاذ الضوء إلى النسيج البالي الغني بالبلاستيدات الخضراء مقر تثبيت ثنائي أكسيد الكربون، بينما تؤمن الثغور في البشرة السفلية دخول CO2 وخروج O2، وبالتالي تتوفر للورقة الطاقة الضوئية والغازات الضرورية لتركيب المادة العضوية.\nالاستنتاج: يسمح التركيب التشريحي للورقة بقيامها بالبناء الضوئي بكفاءة.', segments:[{stepNumber:1,text:'بشرة علوية شفافة، نسيج بالي غني بالبلاستيدات، بشرة سفلية بالثغور',colorClass:'bg-blue-100 dark:bg-blue-900/40 text-blue-800 dark:text-blue-300'},{stepNumber:2,text:'كل طبقة لها دور محدد في الحماية وتبادل الغازات والبناء الضوئي',colorClass:'bg-emerald-100 dark:bg-emerald-900/40 text-emerald-800 dark:text-emerald-300'},{stepNumber:3,text:'نفاذ الضوء إلى البلاستيدات وتثبيت CO2 وتبادل الغازات عبر الثغور',colorClass:'bg-amber-100 dark:bg-amber-900/40 text-amber-800 dark:text-amber-300'},{stepNumber:4,text:'وبالتالي تكيف الورقة للقيام بالبناء الضوئي',colorClass:'bg-purple-100 dark:bg-purple-900/40 text-purple-800 dark:text-purple-300'}] }, stage2:{ clozePrompt:'الملاحظة: نلاحظ {{1}} في الورقة.\nالتفسير: {{2}} أن كل طبقة لها دور:\n- البشرة العليا: {{3}}.\n- النسيج البالي: {{4}}.\n- النسيج المكون للأسفلية: {{5}}.\nالنتيجة: {{6}}.', blanks:[{id:'1',expectedText:'طبقات متعددة متخصصة',hint:'الملاحظة'},{id:'2',expectedText:'يعود ذلك إلى',hint:'الرابط السببي'},{id:'3',expectedText:'حماية',hint:'دور البشرة'},{id:'4',expectedText:'تبادل غازات',hint:'دور النسيج البالي'},{id:'5',expectedText:'بناء ضوئي',hint:'دور النسيج المكون للأسفلية'},{id:'6',expectedText:'تكيف الورقة للقيام بالبناء الضوئي',hint:'النتيجة'}] }, stage3:{ recommendedTimeSec:180, hints:['تأكد من ذكر جميع الطبقات','استخدم رابط سببي واضح','ربط كل طبقة بوظيفتها'] }, stage4:{ timeLimitSec:180, passIcmThreshold:90 } },
  { id:'ex_compare_tectonics_09', verbId:'verb_compare_v1', theme:'geodynamics', themeAr:'الظواهر الجيولوجية', supportType:'schema', supportTitle:'الوثيقة 9: الاصطدام القاري', context:'مقارنة بين الاصطدام القاري والالتباعد القاري من حيث الحركة، النتيجة، والأشكال الجبلية المتكونة.', question:'قارن بين الاصطدام القاري والالتباعد القاري.', dataSnippet:'اصطدام: لوحتان تتحركان نحو بعضهما → سلسلة جبلية.\nالتباعد: لوحتان تتحركان بعيداً عن بعضهما → محيط جديد.', diagramUrl:'/assets/images/schemas/domaine3_tectonique/schema_88_collision_continentale_modern_ar.svg', stage1:{ expertAnswer:'أوجه التشابه: كلاهما حركة للوحات قارية.\nأوجه الاختلاف وفق المعايير:\n- اتجاه الحركة: نحو بعضهما في الاصطدام مقابل بعيد عن بعضهما في الالتباعد.\n- النتيجة: سلسلة جبلية في الاصطدام مقابل محيط جديد في الالتباعد.\n- المثال: الهيمالايا في الاصطدام مقابل المحيط الأطلسي في الالتباعد.\nالخلاصة: الحركة النسبية للوحات القارية تحدد الأشكال الجيولوجية المتكونة.', segments:[{stepNumber:1,text:'أوجه التشابه: كلاهما حركة للوحات القارية',colorClass:'bg-blue-100 dark:bg-blue-900/40 text-blue-800 dark:text-blue-300'},{stepNumber:2,text:'أوجه الاختلاف: اتجاه الحركة، النتيجة، المثال',colorClass:'bg-emerald-100 dark:bg-emerald-900/40 text-emerald-800 dark:text-emerald-300'},{stepNumber:3,text:'بينما... في حين...',colorClass:'bg-amber-100 dark:bg-amber-900/40 text-amber-800 dark:text-amber-300'},{stepNumber:4,text:'الخلاصة: الحركة النسبية تحدد الأشكال الجيولوجية',colorClass:'bg-purple-100 dark:bg-purple-900/40 text-purple-800 dark:text-purple-300'}] }, stage2:{ clozePrompt:'أوجه التشابه: كلاهما {{1}}.\nأوجه الاختلاف:\n- اتجاه الحركة: {{2}}.\n- النتيجة: {{3}}.\nالخلاصة: {{4}}.', blanks:[{id:'1',expectedText:'حركة للوحات قارية',hint:'طبيعة الحركة'},{id:'2',expectedText:'نحو بعضهما في الاصطدام مقابل بعيد في الالتباعد',hint:'اتجاه الحركة'},{id:'3',expectedText:'سلسلة جبلية مقابل محيط جديد',hint:'النتيجة'},{id:'4',expectedText:'الحركة النسبية تحدد الأشكال الجيولوجية',hint:'الخلاصة'}] }, stage3:{ recommendedTimeSec:200, hints:['قارن في جدول أو فقرة مدمجة بالأدوات (بينما / في المقابل)','لا تذكر كل حركة في فقرة منعزلة','اختم بخلاصة تبين الفارق الجوهري'] }, stage4:{ timeLimitSec:200, passIcmThreshold:90 } },
  { id:'ex_calcul_chargaff_10', verbId:'verb_calcul_v1', theme:'protein_synthesis', themeAr:'تركيب البروتين', supportType:'tableau', supportTitle:'الوثيقة 10: تركيب ADN — قواعد Chargaff', context:'في جزيئة ADN، %A = 30%. حسب قواعد Chargaff نعلم أن A=T و G=C و A+G = 50% من القواعد.', question:'احسب النسبة المئوية للغوانين (%G) في هذه الجزيئة.', dataSnippet:'%A = 30%\nChargaff : %A = %T ; %G = %C ; %A + %G = 50%', stage1:{ expertAnswer:'انطلاقا من الوثيقة 10 حسب قانون Chargaff : %A = %T و %G = %C و %A + %G = 50% لأنّ البيورين = بيريميدين.\nبالتعويض: %G = 50% − %A = 50% − 30% = 20% بينما %A يبقى 30%.\nومنه %G = 20% (الوثيقة 10).', segments:[{stepNumber:1,text:'حسب قانون Chargaff : %A = %T و %G = %C و %A + %G = 50%',colorClass:'bg-blue-100 dark:bg-blue-900/40 text-blue-800 dark:text-blue-300'},{stepNumber:2,text:'بالتعويض: %G = 50% − %A = 50% − 30% = 20%',colorClass:'bg-emerald-100 dark:bg-emerald-900/40 text-emerald-800 dark:text-emerald-300'},{stepNumber:3,text:'ومنه %G = 20%',colorClass:'bg-purple-100 dark:bg-purple-900/40 text-purple-800 dark:text-purple-300'}] }, stage2:{ clozePrompt:'القانون: {{1}}\nالتعويض: {{2}}\nالنتيجة: {{3}}', blanks:[{id:'1',expectedText:'%A = %T و %G = %C و %A + %G = 50%',hint:'قانون Chargaff'},{id:'2',expectedText:'%G = 50% − 30% = 20%',hint:'التعويض'},{id:'3',expectedText:'%G = 20%',hint:'النتيجة بوحدتها'}] }, stage3:{ recommendedTimeSec:120, hints:['ابدأ بالقانون بالحروف','عوّض خطوة بخطوة','لا تنس %'] }, stage4:{ timeLimitSec:120, passIcmThreshold:90 } },
