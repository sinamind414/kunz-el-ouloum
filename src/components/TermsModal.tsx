        ...
        >
          ...
          <div className="p-5 sm:p-6 overflow-y-auto flex flex-col gap-4 text-sm text-gray-700 dark:text-gray-300 leading-relaxed font-medium">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-xs">
                صُمم هذا التطبيق للعمل بدون إنترنت حفاظاً على خصوصيتك. <strong>جميع إجاباتك ومستوى تقدمك تُحفظ محلياً على جهازك فقط</strong> (عبر متصفحك)، ولا نطّلع عليها ولا نخزنها على أي خادم خارجي.
                في بعض نسخ التطبيق، قد نرسل <strong>إحصائيات استخدام مجهولة ومحدودة</strong> (مثل: فتح التطبيق، إكمال تمرين، رموز الأخطاء) لتحسين التطبيق فقط. هذه الإحصائيات <strong>لا تتضمن إجاباتك ولا ما تكتبه</strong>، ونحن لا نبيع بياناتك لأي طرف ثالث.
