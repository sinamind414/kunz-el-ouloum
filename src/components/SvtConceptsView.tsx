...
1. بنية الأرض وحركية الصفائح
	البنية الداخلية للأرض: تم تحديدها بالدراسة السيزمية وموجات الانتشار. تفصل بين الطبقات انقطاعات (موهو، غوتنبرغ، ليمان). يتكون الغلاف الصخري (الّليتوسفير) الصلب من القشرة والجزء العلوي للرداء، ويتحرك فوق الغلاف المائع (الاستينوسفير).
	البناء والتوسع (الظهرات): تلتقي تيارات الحمل الحراري الصاعدة عند الظهرات المحيطية، مما يؤدي للانصهار الجزئي لبيريدوتيت الاستينوسفير وصعود الماغما البازلتية التي تتصلب لتشكل قشرة محيطية جديدة (تباعد).
