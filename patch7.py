...
if start_idx != -1:
    # find the end of the legacy lessons section
    first_end = content.find(end_str, start_idx) + len(end_str)
    second_end = content.find(end_str, first_end) + len(end_str)
    
    replacement = """<div className="flex items-center justify-between mb-3 px-1 mt-4">
              <div>
    ...
    content = content[:start_idx] + replacement + content[second_end:]
