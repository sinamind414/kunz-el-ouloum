...
-- Télémétrie : insert anonyme autorisé (buffer offline-first, données non sensibles).
...
create policy "telemetry insert anon" on public.telemetry_events for insert with check (true);
